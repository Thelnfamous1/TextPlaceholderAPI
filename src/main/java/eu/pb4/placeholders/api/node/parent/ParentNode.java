...
public class ParentNode implements ParentTextNode {
    ...
    @Override
    public final Component toText(ParserContext context, boolean removeSingleSlash) {
        ...
        if (this.children.length == 0) {
            ...
            return ((MutableComponent) this.applyFormatting(out.copy(), context)).withStyle(out.getStyle());
        } else {
